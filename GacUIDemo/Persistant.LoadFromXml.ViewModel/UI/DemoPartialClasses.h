...
namespace demos
{
	class CalculatorControl : public demos::CalculatorControl_<demos::CalculatorControl>
	{
		friend class demos::CalculatorControl_<demos::CalculatorControl>;
		friend struct vl::reflection::description::CustomTypeDescriptorSelector<demos::CalculatorControl>;
	protected:
